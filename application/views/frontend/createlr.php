...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <form id="change-lr-form">
            <input type="radio" name="option" value="option1" checked />LRENTRY
            <input type="radio" name="option" value="option2">CPVOLUMETRIC
        </form> 
                            ...
                            <div id="step1" style="display: none;" >
                              ...
                              <div class="row justify-content-center">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control"  id="district" list="District-list" name="district" style='text-transform:uppercase'>
...
<div id="step3" style="display:none;" >
    ...
    <br><br>              
    <input type='submit' class="btn btn-outline-dark btn-fw" class="touch" id='SubmitLR' name='Submit' value='Create LR'>
    <div class="loder">
...
<script type="text/javascript">
    ...
    function step2click() {
        ...
        if (dt !== undefined && dt.trim() !== "") {
            if ($("#formLR")[0].checkValidity()) {
                document.getElementById('btnstep2').style.display = 'none';
                document.getElementById('step2').style.display = 'block';
                $("#step1").find("input, select").prop("disabled", true);
