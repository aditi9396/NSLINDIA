<center>
	...
	?>
	<p style="color:blue; font-size: 25px;">THC NO.<?php echo $str_segment;?> created sucessfully </p> 
</center>
<center>
<p>Consolidated Eway Bill Status: NO Eway Bill No. found in given LR List for Consolidated E-Way Bill Generation</p>
 <input type="button" value="ok" onclick="window.open(base_url+'printthcdemo?THCNO=<?php echo $str_segment;?> ', '_blank', 'width=1200,height=600');">
</center>