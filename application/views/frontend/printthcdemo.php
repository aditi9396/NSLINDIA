...
<body onload="window.print()">
    <p align="middle"><b>THC</b></p>
    <!-- <div id="PrintDiv">
        <p id="bg-text">Cancelled</p>
    </div> -->

     <!-- <input type="button" value="Print" onclick="window.open('printdrsdemo?THCNO=<?php echo $str_segment;?> ', '_blank', 'width=1200,height=600');">
    <input type="button"  onclick="window.open('printdrsvoucher?THCNO', '_blank', 'width=1200,height=600');" value="Print Voucher">
    <input type="button" onclick="window.open('CEWB/cewbno.php?CEWBNo=2251810452', '_blank', 'width=1200,height=600');" value="Consolidated E-Way Bill Print">
-->    <br>
...
<tr>
    ...
    <td><?php echo $thcdata->THCNO; ?></td>
</tr>
<tr style="font-weight: bold;">
    <td><b>DATE</b></td>
    <td><?php echo $thcdata->drsdate; ?></td>
    <td><b>TIME</b></td>
    <td>11:27:00</td>
    <td><b>VEHICLE NO.</b></td>
    <td><?php echo $thcdata->vehicleno; ?></td>
    <td><b>DRIVER MOBILE NO</b></td>
    <td><?php echo $thcdata->mobileno; ?></td>
</tr>
</tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td>1</td>
            <td><?php echo $thcdata->Place; ?></td>
            <td><?php echo $thcdatanew->Consignee; ?></td>
            <td><?php echo $thcdatanew->LRNO; ?></td>
            <td><?php echo $thcdatanew->InvoiceNo; ?></td>
            <td><?php echo $thcdatanew->Qty; ?></td>
            <td><?php echo $thcdatanew->Weight; ?></td>
            <td><?php echo $thcdata->FreightCharge; ?></td>
            <td><?php echo $thcdatanew->Consignor; ?></td>
            <td>11-Jul-2023</td>
        </tr>
    </tbody>
</table>
...
<div class="mt-4">
 <input type="button" onclick="window.open('<?php echo base_url('printthckmtimeroute?THCNO=' . $thcdata->THCNO); ?>','_blank','width=1200,height=600');" value="CALCULATE DISTANCE AND TIME">
 <input type="button" onclick="window.open('<?php echo base_url('printthckmtimemarkeradd?THCNO=' . $thcdata->THCNO); ?>','_blank','width=1200,height=600');" value="ADD MARKERS">
 <input type="button" onclick="window.open('multirequestroute.php?THCNO=DS/PNA/2324/001898','_blank','width=1200,height=600');" value="DRAW MULTI ROUTE">
</div>
</body>
</html>
