  ...
  /*  padding: 2.75rem 2.25rem;
    ...
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title">THC SALES REGISTER</h3>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Forms</a></li>
            <li class="breadcrumb-item active" aria-current="page">THC Sales Register</li>
          </ol>
        </nav>
      </div>
...
<div class="bs-example">
        ...
        <form method="post" action="<?= base_url('searchdata1') ?>" target="_blank"  name="form"><br>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-2">
                            <input type="checkbox" name="check" id="selectall"><b>THC Details</b>    
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="THCNO" checked>THCNO
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="FromPlace" class="check">FromPlace
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="ToPlace" class="check">To Place
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="THCdate" class="check">THCdate
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="VehicleNo" class="check">VehicleNo
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="DriverMobile" class="check">DriverMobile
                        </div>
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="BalanceFreight" class="check">BalanceFreight
                        </div>
                       
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" value="LoadingHamali" class="check">LoadingHamali
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                         <div class="col-sm">
                            <input type="checkbox" name="check[]" class="check" value="UnloadingHamali">UnloadingHamali
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" class="check" value="StartingKM">StartingKM
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" class="check" value="ClosingKM">ClosingKM
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" class="check" value="ArrivalDate">ArrivalDate
                        </div>
                        <div class="col-sm">
                            <input type="checkbox" name="check[]" class="check" value="UpdatedHamali ">UpdatedHamali 
                        </div>
    ...
    <br>
                <div class="button">
        <input type="submit" name="save" id="XLS" value="Download XLS" class="btn btn-outline-dark btn-fw" formaction="<?= base_url('Sales_Register_Controller/xlsxdata3') ?>">
</div><br><br>
        </form>   
                </center>
