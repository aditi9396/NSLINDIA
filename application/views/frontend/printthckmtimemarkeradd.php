...
if (isset($_GET["THCNO"]))
    $THCNO = $_GET["THCNO"];
echo"<input type='hidden' name='drsno' id='drsno' value='$drsdata->THCNO";
...
$str = "<table style='border-collapse: collapse;width:100%;font-size:0.70em;' border=1>
            ...
            <tr><td><b>DIESEL AMOUNT</b></td><td style='font-size:1.3em;font-weight: bold;'>" .$drsdata->dieselamt. "</td><td><b>VEHICLE TYPE</b></td><td>" .$drsdata->THCNO. "</td><td><b>PAYMENT SCHEDULE</b></td><td>" . $drsdata->paymentschedule. "</td></tr>
...
echo "<table style='border-collapse: collapse;width:100%;font-size:0.70em;' border=1>
		...
		<tr><td></td><td>" .  $drsdata->Place. "</td><td>" . $thcdatanew->Consignee. "</td><td>" . $thcdatanew->LRNO . "</td><td>" . $thcdatanew->InvoiceNo. "</td><td>" . $thcdatanew->Qty. "</td>
                <td>" . $thcdatanew->Weight. "</td><td>" . $drsdata->ToPay. "</td><td>" .$thcdatanew->Consignor. "</td><td>" . $drsdata->BookingDate. "</td><td></td><td>".Round(3)." hours</td></tr>";
