    ...
    <div class="content-wrapper">
      ...
      <div class="row">
          <div class="col-12 grid-margin stretch-card">
            ...
            <form name='myForm' method='post' onsubmit="window.open('allstickerprintcp.php','result', 'width=1000,height=600,scrollbars=yes')" action="<?= base_url('allstickerprintcp') ?>" enctype='multipart/form-data'  target='result'>
