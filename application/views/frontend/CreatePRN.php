  ...
  <!-- <script type="text/javascript">
    ...
    $("#partyid").autocomplete({
        ...
        change: function (event, ui) {
            if (!ui.item) {
                // Clear both fields if no valid selection is made
                $("#partyid").val('');
                $("#partyname").val('');
            }
        }
...
function fetchLRNumbers() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            try {
               ...
               /* var lrNumbers = ["LR001", "LR002", "LR003"];*/
   ...
   <div class="main-panel">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-2"></div>
        <div class="col-md-4">
            <input type="text" style="width: 300px;" class="form-control" name="num" id="num" onchange="fetchLRNumbers()" required>
        </div>
    </div>
    <br>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-sm" style="margin-left:80px; margin-top: 20px;">
                <table>
                    <tr>
                        <th>Sr No</th>
                        <th>Lr No</th>
